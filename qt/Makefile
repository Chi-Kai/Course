#############################################################################
# Makefile for building: WoShark
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  WoShark.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile WoShark.pro -spec linux-g++
#############################################################################
...
Makefile: WoShark.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		WoShark.pro
	$(QMAKE) -o Makefile WoShark.pro -spec linux-g++
